...
class Preprocessor(object):
    ...
    def process(self, files, labels, selected_flows):
        ...
        for file, label in zip(files, labels):
            data = np.array(list(self.extract(file, selected_flows).values()))
            # Append data to X
            X.append(data)
            # Append label to y
    ...
    def extract(self, file, selected_flows):
        ...
        # Extract features
        result = self.feature_extractor.extract(result, selected_flows)
